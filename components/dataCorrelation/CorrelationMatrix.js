...
const CorrelationMatrix = () => {
    ...
    return (
        <Box sx={{ height: "83vh", width: "100%", p: 3, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <TableContainer sx={{ height: "100%", width:"80vw", overflow: "auto", borderRadius: "3px", "&::-webkit-scrollbar": { width: "0.6rem", height: "0.6rem", borderRadius: "2rem" }, "&::-webkit-scrollbar-track": { bgcolor: "#e1e1e1" }, "&::-webkit-scrollbar-thumb": { bgcolor: "#a1a1a1", borderRadius: "3rem" } }}>
